...
import { useGetMethodByType } from "@/app/(admin)/dashboard/methods/hooks/api";
import { calculateFee } from "@/shared/utils/calculateFee";
import { HeaderOrder } from "./headerOrder";
import { FormatCurrency } from "@/shared/utils/format";
import { MethodResponseByType } from "@/shared/types/method";
...
export function MethodSection() {
  ...
  const handleMethodSelect = (method: MethodResponseByType) => {

    setSelectedMethod({
      code: method.code,
      feeAmount: method.fee_amount,
      calculationType: method.calculation_type,
